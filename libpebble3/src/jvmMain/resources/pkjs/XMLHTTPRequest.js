class XMLHttpRequest {
    ...
    open(method, url, async = true, user, password) {
        ...
        // Transition synchronously — the native manager drives later readyState changes over an
        // async thread hop, so if we waited for it, an immediate send() would still see UNSENT.
